  ...
  <div>
    <form method="post" action ="${contextPath}/getInfo.do">
      ...
      <div>
        ...
        <input type="checkbox" name="hobbies" id="shopping" value="shopping"><label for="travel">쇼핑</label>
        <input type="checkbox" name="hobbies" id="game" value="game"><label for="travel">게임</label>
      </div>
      <div>
